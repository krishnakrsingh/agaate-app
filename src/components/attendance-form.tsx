      ...
      <>
        <div
          ...
          style={{
            ...
            border: isException ? "1px solid var(--amber)" : "1px solid var(--line)",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
            <span
              style={{
                ...
                background: isException ? "rgba(207, 160, 78, 0.15)" : "var(--green-light)",
                padding: "2px 8px",
                borderRadius: "9999px",
                lineHeight: 1.2,
              }}
    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: "24px",
          boxShadow: "0 24px 48px -12px rgba(23, 59, 41, 0.35)",
