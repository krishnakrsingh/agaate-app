...
import { OwnerOperationsView } from "@modules/operations/ui/owner-operations-view";
import { CalendarEventsData, FarmOption } from "@modules/operations/ui/operations-calendar";
...
export default async function OwnerOperationsPage({ searchParams }: Props) {
      ...
      <>
        ...
        <main className="shell">
          <div className="card" style={{ textAlign: "center", padding: "64px 24px", maxWidth: 480, margin: "48px auto" }}>
            ...
            <Link href="/owner/farms" className="btn btn-primary">
              View Farm Portfolio
            </Link>
          </div>
        </main>
  ...
  // Month boundaries for calendar items
